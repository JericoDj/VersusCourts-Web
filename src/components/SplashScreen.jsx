...
import logoText from '../assets/logos/Logo_Text_No_Background.png'
    ...
    >
      <div className="app-splash-screen__content">
        <div className="app-splash-screen__circle">
          <img src={circularLogo} alt="Versus Courts" className="app-splash-screen__icon" />
        </div>
        <img src={logoText} alt="Versus Courts" className="app-splash-screen__text" />
