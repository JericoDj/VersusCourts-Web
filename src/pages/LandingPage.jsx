...
export default function LandingPage() {
  return (
    <div className="landing">
      ...
      <footer className="public-footer"><div className="container"><div><Brand light /><p>Every court. Every player.<br />One community.</p></div><div><b>EXPLORE</b><Link to="/venues">Find a court</Link><Link to="/app/queues">Open games</Link><Link to="/app/events">Events</Link></div><div><b>VERSUS</b><Link to="/for-business">For business</Link><a href="#community">Community</a><a href="mailto:hello@versuscourts.com">Contact</a></div><div><b>GET IN THE GAME</b><Link className="footer-app-link" to="/app"><span>▶</span><small>LAUNCH THE<br /><b>WEB PLAYER</b></small></Link></div></div><div className="container footer-bottom"><span>© 2026 Versus Courts. All rights reserved.</span><span>Privacy · Terms · Security</span></div></footer>
    </div>
  )
}
